...
const [state]=React.useState(localStorage.getItem('username'))
  return (
 <Card style={{marginTop:"5%",marginLeft:"-2%",width:"100%"}}>
...
editeAddressUpdate=()=>{
  ...
  render() {
    return (
    <div style={{display:"flex",marginLeft:"1px" ,height:"350px",width:"1070px",backgroundImage:'linear-gradient( 166deg, rgb(25, 25, 25) 49%, rgb(23, 55, 255) 80%, rgb(23, 25, 255) 100%)' }}>
      <div >
      <Card style={{width:"250px",height:"300px",marginLeft:"2%",marginTop:"7%"}}>
                    <CardContent>
...
<Grid item xs={4}>
                    ...
                    <CardContent>
                          ...
                          <h4><TextField id="FirstName" label="FirstName" style={{marginLeft:"2%"}} disabled variant="outlined" value={this.state.updateFirstName}
                                      onChange={this.onChangeUpdateFirstName}/><CardContent><Button variant="contained" color="primary" onClick={this.editeFirstName}><EditIcon/></Button></CardContent></h4>
                  ...
                  <DialogContent>
                          ...
                          <DialogActions>
                            <Button onClick={this.editeFirstNameCancel} color="primary">
                              Cancel
                            </Button>
                            <Button  onClick={this.editeFirstNameUpdate} color="primary" autoFocus>
                              Update
                            </Button>
                          </DialogActions>
                        </Dialog>
 ...
 <Grid item xs={4}>
            ...
            <CardContent>
                  ...
                  <h4><TextField id="Lastname" label="LastName" style={{marginLeft:"2%"}} disabled variant="outlined" value={this.state.updateLastName}
                              onChange={this.onChangeUpdateLastName}/><CardContent><Button variant="contained" color="primary" onClick={this.editeLastName}><EditIcon/></Button></CardContent></h4>
                ...
                >
                  ...
                  <DialogActions>
                    <Button onClick={this.editeLastNameCancel} color="primary">
                      Cancel
                    </Button>
                    <Button  onClick={this.editeLastNameUpdate} color="primary" autoFocus>
                      Update
                    </Button>
                  </DialogActions>
                </Dialog>
...
<Grid item xs={4}>
            ...
            <CardContent>
                  ...
                  <h4><TextField  id="email" label="Email" style={{marginLeft:"2%"}} disabled variant="outlined" value={this.state.updateEmail}
                              onChange={this.onChangeUpdateEmail}/><CardContent><Button variant="contained" color="primary" onClick={this.editeEmail}><EditIcon/></Button></CardContent></h4>
                ...
                >
                  ...
                  <DialogActions>
                    <Button onClick={this.editeEmailCancel} color="primary">
                      Cancel
                    </Button>
                    <Button  onClick={this.editeEmailUpdate} color="primary" autoFocus>
                      Update
                    </Button>
                  </DialogActions>
                </Dialog>
...
<Grid item xs={6}>
                    ...
                    <CardContent>
                          ...
                          <h4><TextField  id="Phonenumber" label="PhoneNumber" style={{marginLeft:"2%"}} disabled variant="outlined" value={this.state.updatePhone}
                                      onChange={this.onChangeUpdatePhone}/><CardContent><Button variant="contained" color="primary" onClick={this.editePhone}><EditIcon/></Button></CardContent></h4>
                  ...
                  <DialogContent>
                          ...
                          <DialogActions>
                            <Button onClick={this.editePhoneCancel} color="primary">
                              Cancel
                            </Button>
                            <Button  onClick={this.editePhoneUpdate} color="primary" autoFocus>
                              Update
                            </Button>
                          </DialogActions>
                        </Dialog>
 ...
 <Grid item xs={6}>
            ...
            <CardContent>
                  ...
                  <h4><TextField id="address" label="Address" style={{marginLeft:"2%"}} disabled variant="outlined" value={this.state.updateAddress}
                              onChange={this.onChangeUpdateAddress}/><CardContent><Button variant="contained" color="primary" onClick={this.editeAddress}><EditIcon/></Button></CardContent></h4>
                ...
                >
                  ...
                  <DialogActions>
                    <Button onClick={this.editeAddressCancel} color="primary">
                      Cancel
                    </Button>
                    <Button  onClick={this.editeAddressUpdate} color="primary" autoFocus>
                      Update
                    </Button>
                  </DialogActions>
                </Dialog>
