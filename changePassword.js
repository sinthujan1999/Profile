...
export default function ChangePassword() {
  ...
  return (
    <div >
          <Card style={{marginTop:"5%",marginLeft:"-2%",padding:"0.5%", backgroundPosition: "center", backgroundRepeat: 'no-repeat',
    backgroundSize: "cover", backgroundImage:`url(${ima})`}}>
    ...
    <AppBar position="static" style={{height:"8%",width:"1080px",marginLeft:"-1%"}} >
        ...
        Change Password-{state}
          ...
          <div style={{marginLeft:"-1%",padding:"1%", height:"348px",width:"700px",backgroundImage:'linear-gradient( 166deg, rgb(25, 25, 25) 49%, rgb(23, 55, 255) 80%, rgb(23, 25, 255) 100%)' }}>
          <Typography variant="body2" color="textSecondary" component="p">


       <Card style={{marginTop:"3%",display:"flex",height:"70px",textAlign:"center"}}>
